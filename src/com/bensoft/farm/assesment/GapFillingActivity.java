 ...
 * @author Benson
 */
public class GapFillingActivity extends Activity implements View.OnClickListener {

    private DatePicker dpGapFillingDate;
    ...
    private final static String FORM_TYPE_ID = "13";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_gap_filling);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpGapFillingDate = (DatePicker) findViewById(R.id.dpGapFillingDate);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpGapFillingDate.getYear() + "-" + dpGapFillingDate.getMonth() + "-" + dpGapFillingDate.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(GapFillingActivity.this);
        db = new DatabaseHandler(GapFillingActivity.this);
        pid = getPrefrence(GapFillingActivity.this, "pid");
        user_id = getPrefrence(GapFillingActivity.this, "user_id");
        cid = getPrefrence(GapFillingActivity.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        previous = new Intent(getApplicationContext(), ReplantingActivity.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), ThinningActivity.class);
        //get current date
        d1 = new Date();
