 ...
 * @author Benson
 */
public class ReplantingActivity extends Activity implements OnClickListener {

    private DatePicker dpReplantingDate;
    ...
    private final static String FORM_TYPE_ID = "12";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_replanting);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpReplantingDate = (DatePicker) findViewById(R.id.dpReplantingDate);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpReplantingDate.getYear() + "-" + dpReplantingDate.getMonth() + "-" + dpReplantingDate.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(ReplantingActivity.this);
        db = new DatabaseHandler(ReplantingActivity.this);
        pid = getPrefrence(ReplantingActivity.this, "pid");
        user_id = getPrefrence(ReplantingActivity.this, "user_id");
        cid = getPrefrence(ReplantingActivity.this, "cid");
        ...
        //next form
        next = new Intent(getApplicationContext(), GapFillingActivity.class);
        //get current date
        d1 = new Date();
