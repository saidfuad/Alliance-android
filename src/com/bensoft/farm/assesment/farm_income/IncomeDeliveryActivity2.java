 ...
 * @author Benson
 */
public class IncomeDeliveryActivity2 extends Activity implements View.OnClickListener{

    private EditText etDeliveryDate2;
    ...
    private void initView() {
        etDeliveryDate2 = (EditText) findViewById(R.id.etDeliveryDate2);
