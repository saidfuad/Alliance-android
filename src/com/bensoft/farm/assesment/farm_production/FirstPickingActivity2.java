 ...
 * @author Benson
 */
public class FirstPickingActivity2 extends Activity  implements View.OnClickListener {

    private EditText etPickingDate2;
    ...
    private void initView() {
        etPickingDate2 = (EditText) findViewById(R.id.etPickingDate2);
