 ...
 * @author Benson
 */
public class FirstPickingActivity3 extends Activity  implements View.OnClickListener {

    private EditText etPickingDate3;
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_picking3);
        initView();
        initListeners();
    }

    private void initView() {
        etPickingDate3 = (EditText) findViewById(R.id.etPickingDate3);
