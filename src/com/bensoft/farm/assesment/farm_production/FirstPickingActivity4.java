 ...
 * @author Benson
 */
public class FirstPickingActivity4 extends Activity  implements View.OnClickListener {

    private EditText etPickingDate4;
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_picking4);
        initView();
        initListeners();
    }

    private void initView() {
        etPickingDate4 = (EditText) findViewById(R.id.etPickingDate4);
