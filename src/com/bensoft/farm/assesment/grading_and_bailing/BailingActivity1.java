 ...
 * @author Benson
 */
public class BailingActivity1 extends Activity implements View.OnClickListener{

    private DatePicker dpBailingDate1;
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_bailing1);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpBailingDate1 = (DatePicker) findViewById(R.id.dpBailingDate1);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpBailingDate1.getYear() + "-" + dpBailingDate1.getMonth() + "-" + dpBailingDate1.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(BailingActivity1.this);
        db = new DatabaseHandler(BailingActivity1.this);
        pid = getPrefrence(BailingActivity1.this, "pid");
        user_id = getPrefrence(BailingActivity1.this, "user_id");
        cid = getPrefrence(BailingActivity1.this, "cid");
        ...
        //next form
        next = new Intent(getApplicationContext(), GradingActivity2.class);
        //get current date
        d1 = new Date();
