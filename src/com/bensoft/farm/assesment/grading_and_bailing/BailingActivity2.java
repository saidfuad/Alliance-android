 ...
 * @author Benson
 */
public class BailingActivity2 extends Activity implements View.OnClickListener{

    private DatePicker dpBailingDate2;
    ...
    private final static String FORM_TYPE_ID = "125";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_bailing2);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpBailingDate2 = (DatePicker) findViewById(R.id.dpBailingDate2);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpBailingDate2.getYear() + "-" + dpBailingDate2.getMonth() + "-" + dpBailingDate2.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(BailingActivity2.this);
        db = new DatabaseHandler(BailingActivity2.this);
        pid = getPrefrence(BailingActivity2.this, "pid");
        user_id = getPrefrence(BailingActivity2.this, "user_id");
        cid = getPrefrence(BailingActivity2.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        previous = new Intent(getApplicationContext(), GradingActivity2.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), GradingActivity3.class);
        //get current date
        d1 = new Date();
