 ...
 * @author Benson
 */
public class BailingActivity3 extends Activity implements View.OnClickListener{

    private DatePicker dpBailingDate3;
    ...
    private final static String FORM_TYPE_ID = "127";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_bailing3);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpBailingDate3 = (DatePicker) findViewById(R.id.dpBailingDate3);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpBailingDate3.getYear() + "-" + dpBailingDate3.getMonth() + "-" + dpBailingDate3.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(BailingActivity3.this);
        db = new DatabaseHandler(BailingActivity3.this);
        pid = getPrefrence(BailingActivity3.this, "pid");
        user_id = getPrefrence(BailingActivity3.this, "user_id");
        cid = getPrefrence(BailingActivity3.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        previous = new Intent(getApplicationContext(), GradingActivity3.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), GradingActivity4.class);
        //get current date
        d1 = new Date();
