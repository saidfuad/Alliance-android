...
import com.bensoft.farm.assesment.harvesting.TransportFieldToHseActivity2;
import com.bensoft.farm.assesment.harvesting.TransportFieldToHseActivity3;
 ...
 * @author Benson
 */
public class GradingActivity1 extends Activity implements View.OnClickListener {

    private DatePicker dpGradingDate1;
    ...
    private final static String FORM_TYPE_ID = "122";
    ...
    private void initView() {
        dpGradingDate1 = (DatePicker) findViewById(R.id.dpGradingDate1);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpGradingDate1.getYear() + "-" + dpGradingDate1.getMonth() + "-" + dpGradingDate1.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(GradingActivity1.this);
        db = new DatabaseHandler(GradingActivity1.this);
        pid = getPrefrence(GradingActivity1.this, "pid");
        user_id = getPrefrence(GradingActivity1.this, "user_id");
        cid = getPrefrence(GradingActivity1.this, "cid");
        ...
        //next form
        next = new Intent(getApplicationContext(), BailingActivity1.class);
        //get current date
        d1 = new Date();
