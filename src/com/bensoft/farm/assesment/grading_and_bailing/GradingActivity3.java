 ...
 * @author Benson
 */
public class GradingActivity3 extends Activity implements View.OnClickListener {

    private DatePicker dpGradingDate3;
    ...
    private final static String FORM_TYPE_ID = "126";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_grading3);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpGradingDate3 = (DatePicker) findViewById(R.id.dpGradingDate3);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpGradingDate3.getYear() + "-" + dpGradingDate3.getMonth() + "-" + dpGradingDate3.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(GradingActivity3.this);
        db = new DatabaseHandler(GradingActivity3.this);
        pid = getPrefrence(GradingActivity3.this, "pid");
        user_id = getPrefrence(GradingActivity3.this, "user_id");
        cid = getPrefrence(GradingActivity3.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //previous form
        previous = new Intent(getApplicationContext(), BailingActivity2.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), BailingActivity3.class);
        //get current date
        d1 = new Date();
