 ...
 * @author Benson
 */
public class GradingActivity4 extends Activity implements View.OnClickListener {

    private DatePicker dpGradingDate4;
    ...
    private final static String FORM_TYPE_ID = "128";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_grading4);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpGradingDate4 = (DatePicker) findViewById(R.id.dpGradingDate4);
    ...
    private void initData() {
        cd = new ConnectionDetector(GradingActivity4.this);
        db = new DatabaseHandler(GradingActivity4.this);
        pid = getPrefrence(GradingActivity4.this, "pid");
        user_id = getPrefrence(GradingActivity4.this, "user_id");
        cid = getPrefrence(GradingActivity4.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        newf = new Intent(getApplicationContext(), BailingActivity3.class);
        newf.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //previous form
        previous = new Intent(getApplicationContext(), BailingActivity4.class);
        //next form
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpGradingDate4.getYear() + "-" + dpGradingDate4.getMonth() + "-" + dpGradingDate4.getDayOfMonth();
