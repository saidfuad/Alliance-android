 ...
 * @author Benson
 */
public class HarvestingActivity1 extends Activity implements OnClickListener{

    private DatePicker dpHarvestDate1;
    ...
    private final static String FORM_TYPE_ID = "114";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_harvesting1);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpHarvestDate1 = (DatePicker) findViewById(R.id.dpHarvestDate1);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpHarvestDate1.getYear() + "-" + dpHarvestDate1.getMonth() + "-" + dpHarvestDate1.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(HarvestingActivity1.this);
        db = new DatabaseHandler(HarvestingActivity1.this);
        pid = getPrefrence(HarvestingActivity1.this, "pid");
        user_id = getPrefrence(HarvestingActivity1.this, "user_id");
        cid = getPrefrence(HarvestingActivity1.this, "cid");
        ...
        //next form
        next = new Intent(getApplicationContext(), TransportFieldToHseActivity1.class);
        //get current date
        d1 = new Date();
