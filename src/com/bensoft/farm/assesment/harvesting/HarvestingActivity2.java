 ...
 * @author Benson
 */
public class HarvestingActivity2 extends Activity  implements View.OnClickListener{

    private DatePicker dpHarvestDate2;
    ...
    private final static String FORM_TYPE_ID = "116";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_harvesting2);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpHarvestDate2 = (DatePicker) findViewById(R.id.dpHarvestDate2);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpHarvestDate2.getYear() + "-" + dpHarvestDate2.getMonth() + "-" + dpHarvestDate2.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(HarvestingActivity2.this);
        db = new DatabaseHandler(HarvestingActivity2.this);
        pid = getPrefrence(HarvestingActivity2.this, "pid");
        user_id = getPrefrence(HarvestingActivity2.this, "user_id");
        cid = getPrefrence(HarvestingActivity2.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        previous = new Intent(getApplicationContext(), TransportFieldToHseActivity1.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), TransportFieldToHseActivity2.class);
        //get current date
        d1 = new Date();
