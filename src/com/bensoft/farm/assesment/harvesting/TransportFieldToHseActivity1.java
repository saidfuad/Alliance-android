 ...
 * @author Benson
 */
public class TransportFieldToHseActivity1 extends Activity implements View.OnClickListener {

    private DatePicker dpTransFieldToHseDate1;
    ...
    private final static String FORM_TYPE_ID = "115";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_trans_field_hse1);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpTransFieldToHseDate1 = (DatePicker) findViewById(R.id.dpTransFieldToHseDate1);
    ...
    private void initData() {
        cd = new ConnectionDetector(TransportFieldToHseActivity1.this);
        db = new DatabaseHandler(TransportFieldToHseActivity1.this);
        pid = getPrefrence(TransportFieldToHseActivity1.this, "pid");
        user_id = getPrefrence(TransportFieldToHseActivity1.this, "user_id");
        cid = getPrefrence(TransportFieldToHseActivity1.this, "cid");
...
//        newf.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //previous form
        previous = new Intent(getApplicationContext(), HarvestingActivity1.class);
        //next form
         next = new Intent(getApplicationContext(), HarvestingActivity2.class);
        //get current date
        d1 = new Date();
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpTransFieldToHseDate1.getYear() + "-" + dpTransFieldToHseDate1.getMonth() + "-" + dpTransFieldToHseDate1.getDayOfMonth();
