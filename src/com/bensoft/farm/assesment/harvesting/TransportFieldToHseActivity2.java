 ...
 * @author Benson
 */
public class TransportFieldToHseActivity2 extends Activity implements View.OnClickListener {

    private DatePicker dpTransFieldToHseDate2;
    ...
    private final static String FORM_TYPE_ID = "117";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_trans_field_hse2);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpTransFieldToHseDate2 = (DatePicker) findViewById(R.id.dpTransFieldToHseDate2);
    ...
    private void initData() {
        cd = new ConnectionDetector(TransportFieldToHseActivity2.this);
        db = new DatabaseHandler(TransportFieldToHseActivity2.this);
        pid = getPrefrence(TransportFieldToHseActivity2.this, "pid");
        user_id = getPrefrence(TransportFieldToHseActivity2.this, "user_id");
        cid = getPrefrence(TransportFieldToHseActivity2.this, "cid");
...
//        newf.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //previous form
        previous = new Intent(getApplicationContext(), HarvestingActivity2.class);
        //next form
        next = new Intent(getApplicationContext(), HarvestingActivity3.class);
        //get current date
        d1 = new Date();
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpTransFieldToHseDate2.getYear() + "-" + dpTransFieldToHseDate2.getMonth() + "-" + dpTransFieldToHseDate2.getDayOfMonth();
