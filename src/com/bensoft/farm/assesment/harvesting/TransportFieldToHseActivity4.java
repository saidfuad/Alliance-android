 ...
 * @author Benson
 */
public class TransportFieldToHseActivity4 extends Activity implements View.OnClickListener {

    private DatePicker dpTransFieldToHseDate4;
    ...
    private final static String FORM_TYPE_ID = "121";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_trans_field_hse4);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpTransFieldToHseDate4 = (DatePicker) findViewById(R.id.dpTransFieldToHseDate4);
    ...
    private void initData() {
        cd = new ConnectionDetector(TransportFieldToHseActivity4.this);
        db = new DatabaseHandler(TransportFieldToHseActivity4.this);
        pid = getPrefrence(TransportFieldToHseActivity4.this, "pid");
        user_id = getPrefrence(TransportFieldToHseActivity4.this, "user_id");
        cid = getPrefrence(TransportFieldToHseActivity4.this, "cid");
        ...
        //previous form
        previous = new Intent(getApplicationContext(), HarvestingActivity4.class);
        //next form
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpTransFieldToHseDate4.getYear() + "-" + dpTransFieldToHseDate4.getMonth() + "-" + dpTransFieldToHseDate4.getDayOfMonth();
