 ...
 * @author Benson
 */
public class RidgingActivity extends Activity implements OnClickListener {

    private DatePicker dpRidgingDate;
    ...
    private final static String FORM_TYPE_ID = "6";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_ridging);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpRidgingDate = (DatePicker) findViewById(R.id.dpRidgingDate);
    ...
    private void initData() {
        cd = new ConnectionDetector(RidgingActivity.this);
        db = new DatabaseHandler(RidgingActivity.this);
        pid = getPrefrence(RidgingActivity.this, "pid");
        user_id = getPrefrence(RidgingActivity.this, "user_id");
        cid = getPrefrence(RidgingActivity.this, "cid");
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpRidgingDate.getYear() + "-" + dpRidgingDate.getMonth() + "-" + dpRidgingDate.getDayOfMonth();
