 ...
 * @author Benson
 */
public class RippingActivity extends Activity implements OnClickListener {

    private RadioButton rbTractor;
    private RadioButton rbOxen;
    private DatePicker dpRippingDate;
    ...
    private final static String FORM_TYPE_ID = "4";
    private String collect_date;
    private String ripping_method;
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_ripping);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        ...
        dpRippingDate = (DatePicker) findViewById(R.id.dpRippingDate);
    ...
    private void initData() {
        cd = new ConnectionDetector(RippingActivity.this);
        db = new DatabaseHandler(RippingActivity.this);
        pid = getPrefrence(RippingActivity.this, "pid");
        user_id = getPrefrence(RippingActivity.this, "user_id");
        cid = getPrefrence(RippingActivity.this, "cid");
        ...
        //previous form
        previous = new Intent(getApplicationContext(), PloughingActivity.class);
        //next form
        next = new Intent(getApplicationContext(), PotholingActivity.class);
        //get current date
        d1 = new Date();
    ...
    public void onClick(View v) {
        if (v == rbTractor) {
            ...
            activity_date = dpRippingDate.getYear() + "-" + dpRippingDate.getMonth() + "-" + dpRippingDate.getDayOfMonth();
            ...
            if (!"".equals(activity_date) && !"".equals(family_hours) && !"".equals(hired_hours) && !"".equals(money_out) && !"".equals(remarks)) {
                db.addFarmAssMajor(new FarmAssFormsMajor(pid, FORM_TYPE_ID, ripping_method, activity_date, family_hours, hired_hours, money_out, remarks, user_id, collect_date, String.valueOf(lat), String.valueOf(longt), cid));
                startActivity(next);
            } else {
