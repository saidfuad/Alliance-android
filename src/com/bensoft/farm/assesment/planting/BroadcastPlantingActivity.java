 ...
 */
package com.bensoft.farm.assesment.planting;
 ...
 * @author Benson
 */
public class BroadcastPlantingActivity extends Activity implements OnClickListener {

    private DatePicker dpBroadcastPlantingDate;
    ...
    private final static String FORM_TYPE_ID = "8";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_broadcast_planting);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpBroadcastPlantingDate = (DatePicker) findViewById(R.id.dpBroadcastPlantingDate);
    ...
    private void initData() {
        cd = new ConnectionDetector(BroadcastPlantingActivity.this);
        db = new DatabaseHandler(BroadcastPlantingActivity.this);
        pid = getPrefrence(BroadcastPlantingActivity.this, "pid");
        user_id = getPrefrence(BroadcastPlantingActivity.this, "user_id");
        cid = getPrefrence(BroadcastPlantingActivity.this, "cid");
        ...
        //previous form
        previous = new Intent(getApplicationContext(), RowPlantingActivity.class);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpBroadcastPlantingDate.getYear() + "-" + dpBroadcastPlantingDate.getMonth() + "-" + dpBroadcastPlantingDate.getDayOfMonth();
