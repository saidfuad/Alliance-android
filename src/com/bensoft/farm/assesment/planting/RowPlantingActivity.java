 ...
 * @author Benson
 */
public class RowPlantingActivity extends Activity implements View.OnClickListener {
    ...
    private final static String FORM_TYPE_ID = "7";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_row_planting);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpRowPlantingDate = (DatePicker) findViewById(R.id.dpRowPlantingDate);
    ...
    private void initData() {
        ...
        pid = getPrefrence(RowPlantingActivity.this, "pid");
        user_id = getPrefrence(RowPlantingActivity.this, "user_id");
        cid = getPrefrence(RowPlantingActivity.this, "cid");
        ...
        //next form
        next = new Intent(getApplicationContext(), BroadcastPlantingActivity.class);
        //get current date
        d1 = new Date();
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpRowPlantingDate.getYear() + "-" + dpRowPlantingDate.getMonth() + "-" + dpRowPlantingDate.getDayOfMonth();
