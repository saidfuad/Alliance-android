 ...
 * @author Benson
 */
public class StalkDestructionActivity1 extends Activity implements View.OnClickListener {

    private DatePicker dpStalkDestructionDate1;
    ...
    private final static String FORM_TYPE_ID = "130";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_stalk_destroy1);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpStalkDestructionDate1 = (DatePicker) findViewById(R.id.dpStalkDestructionDate1);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpStalkDestructionDate1.getYear() + "-" + dpStalkDestructionDate1.getMonth() + "-" + dpStalkDestructionDate1.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(StalkDestructionActivity1.this);
        db = new DatabaseHandler(StalkDestructionActivity1.this);
        pid = getPrefrence(StalkDestructionActivity1.this, "pid");
        user_id = getPrefrence(StalkDestructionActivity1.this, "user_id");
        cid = getPrefrence(StalkDestructionActivity1.this, "cid");
        ...
        //next form
        next = new Intent(getApplicationContext(), StalkDestructionActivity2.class);
        //get current date
        d1 = new Date();
