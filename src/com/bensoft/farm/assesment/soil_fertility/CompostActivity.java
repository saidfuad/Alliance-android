...
public class CompostActivity extends Activity implements View.OnClickListener {
    ...
    private DatePicker dpCompostingDate;
    ...
    private final static String FORM_TYPE_ID = "16";
    ...
    private void initView() {
        dpCompostingDate = (DatePicker) findViewById(R.id.dpCompostingDate);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpCompostingDate.getYear() + "-" + dpCompostingDate.getMonth() + "-" + dpCompostingDate.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(CompostActivity.this);
        db = new DatabaseHandler(CompostActivity.this);
        pid = getPrefrence(CompostActivity.this, "pid");
        user_id = getPrefrence(CompostActivity.this, "user_id");
        cid = getPrefrence(CompostActivity.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        previous = new Intent(getApplicationContext(), MulchingActivity.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), ManureActivity.class);
        //get current date
        d1 = new Date();
