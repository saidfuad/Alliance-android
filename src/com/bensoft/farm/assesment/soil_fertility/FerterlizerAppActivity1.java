 ...
 * @author Benson
 */
public class FerterlizerAppActivity1 extends Activity implements View.OnClickListener {

    private DatePicker dpFertAppDate1;
    ...
    private final static String FORM_TYPE_ID = "18";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_fert_app1);
         initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpFertAppDate1 = (DatePicker) findViewById(R.id.dpFertAppDate1);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpFertAppDate1.getYear() + "-" + dpFertAppDate1.getMonth() + "-" + dpFertAppDate1.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(FerterlizerAppActivity1.this);
        db = new DatabaseHandler(FerterlizerAppActivity1.this);
        pid = getPrefrence(FerterlizerAppActivity1.this, "pid");
        user_id = getPrefrence(FerterlizerAppActivity1.this, "user_id");
        cid = getPrefrence(FerterlizerAppActivity1.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        previous = new Intent(getApplicationContext(), ManureActivity.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), FerterlizerAppActivity2.class);
        //get current date
        d1 = new Date();
