 ...
 * @author Benson
 */
public class FerterlizerAppActivity2 extends Activity implements View.OnClickListener {

    private DatePicker dpFertAppDate2;
    ...
    private final static String FORM_TYPE_ID = "19";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_fert_app2);
        initListeners();
        initData();
    }

    private void initView() {
        dpFertAppDate2 = (DatePicker) findViewById(R.id.dpFertAppDate2);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpFertAppDate2.getYear() + "-" + dpFertAppDate2.getMonth() + "-" + dpFertAppDate2.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(FerterlizerAppActivity2.this);
        db = new DatabaseHandler(FerterlizerAppActivity2.this);
        pid = getPrefrence(FerterlizerAppActivity2.this, "pid");
        user_id = getPrefrence(FerterlizerAppActivity2.this, "user_id");
        cid = getPrefrence(FerterlizerAppActivity2.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        previous = new Intent(getApplicationContext(), FerterlizerAppActivity2.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), FoliarFeedActivity1.class);
        //get current date
        d1 = new Date();
