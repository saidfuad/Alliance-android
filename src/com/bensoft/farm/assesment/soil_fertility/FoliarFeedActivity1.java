...
import com.bensoft.farm.assesment.herb_application.HerbApplicationActivity2;
 ...
 * @author Benson
 */
public class FoliarFeedActivity1 extends Activity  implements View.OnClickListener{

    private DatePicker dpFoliarFeedDate1;
    ...
    private final static String FORM_TYPE_ID = "20";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_foliar_feed1);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpFoliarFeedDate1 = (DatePicker) findViewById(R.id.dpFoliarFeedAppDate1);
    ...
    private void initData() {
        cd = new ConnectionDetector(FoliarFeedActivity1.this);
        db = new DatabaseHandler(FoliarFeedActivity1.this);
        pid = getPrefrence(FoliarFeedActivity1.this, "pid");
        user_id = getPrefrence(FoliarFeedActivity1.this, "user_id");
        cid = getPrefrence(FoliarFeedActivity1.this, "cid");
    ...
    public void onClick(View v) {
        if (v == rbKnapsack) {
            ...
            activity_date = dpFoliarFeedDate1.getYear() + "-" + dpFoliarFeedDate1.getMonth() + "-" + dpFoliarFeedDate1.getDayOfMonth();
