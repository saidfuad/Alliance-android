 ...
 * @author Benson
 */
public class MulchingActivity extends Activity implements OnClickListener {

    private DatePicker dpMulchingDate;
    ...
    private final static String FORM_TYPE_ID = "15";
    ...
    private void initView() {
        dpMulchingDate = (DatePicker) findViewById(R.id.dpMulchingDate);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpMulchingDate.getYear() + "-" + dpMulchingDate.getMonth() + "-" + dpMulchingDate.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(MulchingActivity.this);
        db = new DatabaseHandler(MulchingActivity.this);
        pid = getPrefrence(MulchingActivity.this, "pid");
        user_id = getPrefrence(MulchingActivity.this, "user_id");
        cid = getPrefrence(MulchingActivity.this, "cid");
        ...
        //next form
        next = new Intent(getApplicationContext(), CompostActivity.class);
        //get current date
        d1 = new Date();
