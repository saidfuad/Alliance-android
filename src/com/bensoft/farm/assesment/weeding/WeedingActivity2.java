 ...
 * @author Benson
 */
public class WeedingActivity2 extends Activity  implements View.OnClickListener {

    private DatePicker dpWeedingDate2;
    ...
    private final static String FORM_TYPE_ID = "24";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_weeding2);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpWeedingDate2 = (DatePicker) findViewById(R.id.dpWeedingDate2);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpWeedingDate2.getYear() + "-" + dpWeedingDate2.getMonth() + "-" + dpWeedingDate2.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(WeedingActivity2.this);
        db = new DatabaseHandler(WeedingActivity2.this);
        pid = getPrefrence(WeedingActivity2.this, "pid");
        user_id = getPrefrence(WeedingActivity2.this, "user_id");
        cid = getPrefrence(WeedingActivity2.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        previous = new Intent(getApplicationContext(), WeedingActivity1.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), WeedingActivity3.class);
        //get current date
        d1 = new Date();
