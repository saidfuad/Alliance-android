 ...
 * @author Benson
 */
public class WeedingActivity3 extends Activity implements View.OnClickListener {

    private DatePicker dpWeedingDate3;
    ...
    private final static String FORM_TYPE_ID = "25";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_weeding3);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpWeedingDate3 = (DatePicker) findViewById(R.id.dpWeedingDate3);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpWeedingDate3.getYear() + "-" + dpWeedingDate3.getMonth() + "-" + dpWeedingDate3.getDayOfMonth();
    ...
    private void initData() {
        cd = new ConnectionDetector(WeedingActivity3.this);
        db = new DatabaseHandler(WeedingActivity3.this);
        pid = getPrefrence(WeedingActivity3.this, "pid");
        user_id = getPrefrence(WeedingActivity3.this, "user_id");
        cid = getPrefrence(WeedingActivity3.this, "cid");
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //GPS
        gpsTracker = new GPSTracker(getApplicationContext());
        //
        previous = new Intent(getApplicationContext(), WeedingActivity2.class);
        previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        //next form
        next = new Intent(getApplicationContext(), WeedingActivity4.class);
        //get current date
        d1 = new Date();
