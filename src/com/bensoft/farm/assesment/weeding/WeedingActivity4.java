 ...
 * @author Benson
 */
public class WeedingActivity4 extends Activity implements View.OnClickListener {

    private DatePicker dpWeedingDate4;
    private EditText etFamilyHours;
    private EditText etHiredHours;
    private EditText etMoneyOut;
    private EditText etRemarks;
    private Button bBack;private Button bSave;
    ...
    private final static String FORM_TYPE_ID = "26";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_weeding4);
        initView();
        initListeners();
        initData();
    }
    ...
    private void initView() {
        dpWeedingDate4 = (DatePicker) findViewById(R.id.dpWeedingDate4);
    ...
    private void initData() {
        cd = new ConnectionDetector(WeedingActivity4.this);
        db = new DatabaseHandler(WeedingActivity4.this);
        pid = getPrefrence(WeedingActivity4.this, "pid");
        user_id = getPrefrence(WeedingActivity4.this, "user_id");
        cid = getPrefrence(WeedingActivity4.this, "cid");
        ...
        //previous form
        previous = new Intent(getApplicationContext(), PotholingActivity.class);
        //next form
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            activity_date = dpWeedingDate4.getYear() + "-" + dpWeedingDate4.getMonth() + "-" + dpWeedingDate4.getDayOfMonth();
